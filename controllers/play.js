...
module.exports.savePlay = async (ctx, next) => {
  try {
    isLogin(ctx, next);
    const {
      name,
...
module.exports.getPlay = async (ctx, next) => {
  try {
    isLogin(ctx, next);
    const {
      pageIndex,
...
module.exports.getPlayCount = async (ctx, next) => {
  try {
    isLogin(ctx, next);
    const {
      publicNumber,
...
module.exports.deletePlay = async (ctx, next) => {
  try {
    isLogin(ctx, next);
...
module.exports.getOnePlay = async (ctx, next) => {
  try {
    isLogin(ctx, next);
    const { id } = ctx.request.query;
    res = await mysql("cPublicNumber").where({
...
module.exports.updatePlay = async (ctx, next) => {
  try {
    isLogin(ctx, next);
    const {
      id,
