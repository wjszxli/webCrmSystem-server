...
module.exports.saveWeibo = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            name,
...
module.exports.getWeibo = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            pageIndex,
...
module.exports.getWeiboCount = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            publicNumber,
...
module.exports.deleteWeibo = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            id
...
module.exports.getOneWeibo = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            id
...
module.exports.updateWeibo = async (ctx, next) => {
    try {
        isLogin(ctx, next)
        const {
            id,
